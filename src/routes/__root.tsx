...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "NSDR Recept is an AI-powered clinical tool for healthcare professionals to generate personalized wellness prescriptions." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "NSDR Recept is an AI-powered clinical tool for healthcare professionals to generate personalized wellness prescriptions." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "NSDR Recept is an AI-powered clinical tool for healthcare professionals to generate personalized wellness prescriptions." },
